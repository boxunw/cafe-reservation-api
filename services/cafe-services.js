...
const cafeServices = {
  ...
  //       throw error
  //     }
  //     // find cafes having the seat type
  ...
  //       }
  //     })
  //     // then find cafes having the timeslot
  //     const filteredTables = await Promise.all(tables.map(async table => {
  ...
  //         }
  //       })
  //       if (reservations.length >= table.count) {
  //         return null
  //       }
  //       return table
  //     }))
  //     // then find cafes are as same as the assigned city if needed
  //     const newFilteredTables = city && city !== ''
  //       ? filteredTables.filter(table => table && table.Cafe.City.city === city)
  //       : filteredTables.filter(Boolean)
  //     const cafes = newFilteredTables.map(table => ({
  //       id: table.Cafe.id,
  //       name: table.Cafe.name,
  //       cover: table.Cafe.cover,
  //       intro: table.Cafe.intro,
  //       city: table.Cafe.City.city
  //     }))
  //     return cb(null, cafes)
  //   } catch (err) {
  //     if (err.isExpected) {
